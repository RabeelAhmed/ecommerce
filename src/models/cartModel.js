...
const addItemToCart = async (userId, productId, quantity) => {
    ...
    await pool.query(query, [cartId, productId, quantity, stock]);
...
const updateCartItem = async (userId, productId, quantity) => {
    ...
    await pool.query(
        'UPDATE cart_items SET quantity = LEAST($1::int, $2::int) WHERE cart_id = $3 AND product_id = $4',
        [quantity, stock, cartId, productId]
    );
